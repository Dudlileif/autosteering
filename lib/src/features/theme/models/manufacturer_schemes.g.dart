...
_ManufacturerColors _$ManufacturerColorsFromJson(Map<String, dynamic> json) =>
    _ManufacturerColors(
      name: json['name'] as String,
      primary: const ColorSerializer().fromJson(json['primary'] as String),
      tertiary: _$JsonConverterFromJson<String, Color?>(
        json['tertiary'],
        const ColorSerializerNullable().fromJson,
      ),
...
Map<String, dynamic> _$ManufacturerColorsToJson(
  _ManufacturerColors instance,
) => <String, dynamic>{
  'name': instance.name,
  'primary': const ColorSerializer().toJson(instance.primary),
  'tertiary': const ColorSerializerNullable().toJson(instance.tertiary),
  'brandingLine': const ColorSerializerNullable().toJson(instance.brandingLine),
