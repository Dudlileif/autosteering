...
// Descriptions for settings keys are pretty straight forward.
...
enum SettingsKey {
  ...
  logHardwareCombined('log.hardware.combined'),
  logHardwareGNSS('log.hardware.gnss'),
  logHardwareIMU('log.hardware.imu'),
  logHardwareWAS('log.hardware.was'),
