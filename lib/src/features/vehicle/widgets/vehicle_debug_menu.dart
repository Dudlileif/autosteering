        ...
        Consumer(
          ...
          builder: (context, ref, child) => CheckboxListTile(
            ...
            onChanged: (value) => value != null
                ? ref
                      .read(
                        debugVehicleTravelledPathProvider.notifier,
                      )
                      .update(value: value)
                : null,
            title: Column(
              ...
              children: [
                ...
                Slider.adaptive(
                  ...
                  onChanged: (value) => ref
                      .read(
                        debugVehicleTravelledPathSizeProvider.notifier,
                      )
                      .update(value.toInt()),
                  min: 1,
                  max: 1000,
        ...
        Consumer(
          ...
          builder: (context, ref, child) => CheckboxListTile(
            ...
            onChanged: (value) => value != null
                ? ref
                      .read(
                        debugVehicleAntennaPositionProvider.notifier,
                      )
                      .update(value: value)
                : null,
            secondary: child,
        ...
        Consumer(
          ...
          builder: (context, ref, child) => CheckboxListTile(
            ...
            onChanged: (value) => value != null
                ? ref
                      .read(
                        devicePositionAsVehiclePositionProvider.notifier,
                      )
                      .update(value: value)
                : null,
            secondary: child,
