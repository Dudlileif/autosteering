  ...
  Widget build(BuildContext context) {
    ...
    return MenuButtonWithChildren(
      ...
      menuChildren: [
          ...
          child: Consumer(
            builder: (context, ref, child) {
              ...
              return SelectableText.rich(
                TextSpan(
                  text: '${strings.latitudeShort}:',
                  style: GoogleFonts.robotoMono(textStyle: textStyle),
                  children: [
                    TextSpan(
                      text:
                          '''${numberFormatter.format(position.latitude).padLeft(14)}°''',
                      style: GoogleFonts.robotoMono(textStyle: textStyle),
                    ),
                    TextSpan(
                      text: '\n${strings.longitudeShort}:',
                      style: GoogleFonts.robotoMono(textStyle: textStyle),
                      children: [
                        TextSpan(
                          text:
                              '''${numberFormatter.format(position.longitude).padLeft(14)}°''',
                          style: GoogleFonts.robotoMono(textStyle: textStyle),
                        ),
                      ],
                    ),
        ...
        Consumer(
          child: Text(strings.homeSetToScreenCenter, style: textStyle),
        ...
        MenuItemButton(
          ...
          child: Text(strings.homeEnterPosition, style: textStyle),
        ),
      ],
    );
  }
              ...
              children: [
                ...
                Consumer(
                  builder: (context, ref, child) => FilledButton.icon(
                    ...
                    label: Text(strings.homeUseEnteredPosition),
                  ),
                ),
              ],
            ),
