          ...
          child: Consumer(
            builder:
                (context, ref, child) => FloatingActionButton(
                  ...
                  onPressed:
                      ref.read(centerMapOnVehicleProvider.notifier).invert,
                ...
                (context, ref, child) => FloatingActionButton(
                  ...
                  child: Consumer(
                    builder: (context, ref, child) {
                      final angle =
                          ref.watch(gaugeBearingProvider) * 2 * pi / 360;
                      ...
                      const ring = Icon(Icons.location_searching, size: 30);

                      const navIcon = Icon(Icons.navigation_outlined, size: 20);
