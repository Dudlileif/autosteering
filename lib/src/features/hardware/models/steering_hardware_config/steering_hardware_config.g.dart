...
_SteeringHardwareConfig _$SteeringHardwareConfigFromJson(
  ...
  coolstepThresholdRPM: (json['TCOOLTHRS_RPM'] as num?)?.toDouble() ?? 50,
  stealthChopThresholdRPM: (json['TPWMTHRS_RPM'] as num?)?.toDouble() ?? 40,
  chopperMode: json['chm'] as bool? ?? false,
  ...
  pidP: (json['pid_P'] as num?)?.toDouble() ?? 3,
  pidI: (json['pid_I'] as num?)?.toDouble() ?? 0,
  pidD: (json['pid_D'] as num?)?.toDouble() ?? 2,
...
Map<String, dynamic> _$SteeringHardwareConfigToJson(
  _SteeringHardwareConfig instance,
) => <String, dynamic>{
